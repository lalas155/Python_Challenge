...
IMPORTANT: codes work with files with specific-daily-names, this means that if you run the download code to download files at 23:59 and then try to run the next codes at 00:00 or further they will not work, because they will search for the previous day .csv files.
